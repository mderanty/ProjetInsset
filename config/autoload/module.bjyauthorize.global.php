    ...
    'bjyauthorize' => array(
        ...
        'guards' => array(
            'BjyAuthorize\Guard\Route' => array(
                ...
                array('route' => 'projet/list-projet', 'roles' => array('guest', 'user', 'admin')),                
                array('route' => 'projet', 'roles' => array('guest', 'user', 'admin')),                
                array('route' => 'projet/tache', 'roles' => array('guest', 'user', 'admin')),                
                array('route' => 'home/login', 'roles' => array('guest', 'user', 'admin')),                
                array('route' => 'home/admin', 'roles' => array('guest', 'user', 'admin')),                
